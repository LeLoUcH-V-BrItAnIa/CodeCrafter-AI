...
# installed.
TCL_PREFIX='E:/MCA/Python/rest_api/apienv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/MCA/Python/rest_api/apienv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/MCA/Python/rest_api/apienv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/MCA/Python/rest_api/apienv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/MCA/Python/rest_api/apienv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/MCA/Python/rest_api/apienv\Library\lib\tclstub86.lib'
